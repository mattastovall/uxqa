...
import { SimulatorControls, type ControlsVariant, type ControlsVisibility } from "./SimulatorControls.js";
...
export type BrowserSimulatorProps = SimulatorSource & (ControlledSelection | UncontrolledSelection) & Readonly<{
  ...
  controlVariant?: ControlsVariant;
...
export function BrowserSimulator(props: BrowserSimulatorProps) {
  const { controls = true, controlVariant = "native", profiles: customProfiles, className, style, hostname, onLoad, onError } = props;
